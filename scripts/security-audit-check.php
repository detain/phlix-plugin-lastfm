 ...
 *
 * Declared as a constant so {@see \Phlix\Tests\Unit\Plugins\Scrobbler\Lastfm\SecurityAuditCheckTest} can assert the list directly
 ...
 *
 * Measured on this repository's committed lock 2026-08-06: 40 packages
 * (6 require + 34 require-dev). The floor sits below that so ordinary
 ...
 * on this repository's committed lock: 34 dev packages.
 */
const MIN_AUDITED_DEV_PACKAGES = 29;
